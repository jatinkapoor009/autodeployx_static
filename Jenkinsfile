pipeline {
    ...
    stages {
        ...
        stage('Push to Docker Hub') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'ab0e416b-4966-458f-b41f-542592f626e7', passwordVariable: 'DOCKER_HUB_PASSWORD', usernameVariable: 'DOCKER_HUB_USERNAME')]) {
